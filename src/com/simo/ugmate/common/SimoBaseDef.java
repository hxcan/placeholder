...
public class SimoBaseDef 
{
	...
	public static final int SIMO_TOUCH_TouchDown = 1 << 0; // on all touch downs
	public static final int SIMO_TOUCH_TouchDownRepeat = 1 << 1; // on multiple
																	// touchdowns
																	// (tap
																	// count >
																	// 1)
	...
	public static final String EXCEPTION_FILE = "skyroam_x2app_log.txt"; //!<例外的日志文件名，这个日志文件不删除。
	
	//gmate log dir 
	public static final String LOG_BASE_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"com.skyroam.x2app"+File.separator+"Log"; //!<日志目录的路径。
	public static final String LOG_DIR_FILE = "Skyroam"+File.separator+"Log";
	public static final String LOG_BASE_ZIP_DIR = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"Skyroam"+File.separator+"Log.zip";	
	
	public static final String LOG_GMATE_DIR = "GMATE";
	...
	//Simo upgrade send file task
	public static final String UPGRADE_FILE_URL = "192.168.1.1";
	public static final int UPGRADE_FILE_PORT = 9018;
	public static final int UPGRADE_FILE_TYPE = 8;
