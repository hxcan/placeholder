package com.stupidbeauty.blindbox;
...
// 		public static final String TRANSLATE_REQUEST_QUEUE_NAME = "com.stupidbeauty.hxlauncher.VoiceCommandHitDataQueue.cbor"; //!<语音命中应用事件报告队列名字。
		public static final String TRANSLATE_REQUEST_QUEUE_NAME = "com.stupidbeauty.appstore.core.DownloadFailureQueue.cbor"; //!< Download failure 事件报告队列名字。
