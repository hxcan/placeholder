...
public interface DownloadRequestorInterface
{
    ...
    public void reportDownloadFinished(String packageName);     //!< 报告，下载 finished。
    
    public void reportDownloadProgress(String packageName, long downloaded, long total); //!< 报告，下载 progress。
    
    public void  reportDownloadFailed(String packageName); //!< 报告，下载失败。
}
